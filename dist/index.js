...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_fetchLeaderboard_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/fetchLeaderboard.js */ \"./src/modules/fetchLeaderboard.js\");\n/* harmony import */ var _modules_renderLeaderboard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/renderLeaderboard.js */ \"./src/modules/renderLeaderboard.js\");\n\r\n\r\n\r\n\r\nconst reloadBtn = document.getElementById('refresh-btn');\r\nconst form = document.getElementById('add-form');\r\nconst nameToAdd = document.getElementById('name');\r\nconst scoreToAdd = document.getElementById('score');\r\n\r\nconst renderListOnload = async () => {\r\n  const newList = await (0,_modules_fetchLeaderboard_js__WEBPACK_IMPORTED_MODULE_1__.getScores)();\r\n  (0,_modules_renderLeaderboard_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(newList);\r\n};\r\n\r\nwindow.onload = renderListOnload();\r\n\r\nreloadBtn.addEventListener('click', async () => {\r\n  const newList = await (0,_modules_fetchLeaderboard_js__WEBPACK_IMPORTED_MODULE_1__.getScores)();\r\n  (0,_modules_renderLeaderboard_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(newList);\r\n});\r\n\r\nform.addEventListener('submit', async (e) => {\r\n  e.preventDefault();\r\n  await (0,_modules_fetchLeaderboard_js__WEBPACK_IMPORTED_MODULE_1__.addScore)(nameToAdd.value, scoreToAdd.valueAsNumber);\r\n  nameToAdd.value = '';\r\n  scoreToAdd.value = '';\r\n});\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");

/***/ }),

/***/ "./src/modules/fetchLeaderboard.js":
/*!*****************************************!*\
  !*** ./src/modules/fetchLeaderboard.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addScore\": () => (/* binding */ addScore),\n/* harmony export */   \"getScores\": () => (/* binding */ getScores)\n/* harmony export */ });\nconst apiUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/Rs6nOVuEsBL48H3aGZaH/scores/';\r\n\r\nconst getScores = async () => {\r\n  const response = await fetch(apiUrl);\r\n  const jsonData = await response.json();\r\n  return jsonData.result;\r\n};\r\n\r\nconst addScore = async (user, score) => {\r\n  const newScore = {\r\n    user,\r\n    score,\r\n  };\r\n  const response = await fetch(apiUrl, {\r\n    method: 'POST',\r\n    headers: {\r\n      'Content-Type': 'application/json',\r\n    },\r\n    body: JSON.stringify(newScore),\r\n  });\r\n  const jsonData = await response.json();\r\n  return jsonData.result;\r\n};\r\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/fetchLeaderboard.js?");

/***/ }),

/***/ "./src/modules/renderLeaderboard.js":
/*!******************************************!*\
  !*** ./src/modules/renderLeaderboard.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst leaderBoard = document.getElementById('leaderboard');\n\nconst renderLeaderboard = (scoreList) => {\n  let renderText = '';\n  let odd;\n  scoreList.forEach((score, idx) => {\n    odd = '';\n    if (idx % 2 === 0) {\n      odd = 'odd-row';\n    }\n    renderText += `\n        <div class=\"leaderboard-row ${odd}\">\n          <p class=\"row-description\">${score.user}: ${score.score}</p>\n        </div>\n        `;\n  });\n  leaderBoard.innerHTML = renderText;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (renderLeaderboard);\n\n//# sourceURL=webpack://leaderboard/./src/modules/renderLeaderboard.js?");

/***/ }),

/***/ "./src/assets/leader-back.png":
/*!************************************!*\
  !*** ./src/assets/leader-back.png ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"8d8cae7c8244402d98c0.png\";\n\n//# sourceURL=webpack://leaderboard/./src/assets/leader-back.png?");
